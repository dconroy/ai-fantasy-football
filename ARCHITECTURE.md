...
- **Auto-draft** (`autoPickMs`, default 20s for generic mocks and 30s for demo rooms): `autoPickDeadline()`
...
and an absent manager is auto-drafted after 30s in demo rooms so the room never stalls.
...
sequenceDiagram
    ...
    Note over Picker,Board: Fallback — nobody confirms within autoPickMs (30s in demo rooms)
